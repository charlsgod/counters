...
class CreateCounterUseCase @Inject constructor(private val repository: CounterRepository) {

    operator fun invoke(counter: Counter): Flow<ResultCounter> = repository.createCounter(counter)
